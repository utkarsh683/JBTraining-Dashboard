    ...
    <div class="container">
        ...
        <div class="main-content" id="mainContent">
            ...
            <section id="how-to-process" class="section">
                ...
                <h3 id="general-rules">⚙️ General Rules</h3>
                <div class="table-container">
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>➤ XCG-101 (Purchase Summary)</td>
                            ...
                            <tr>
                                ...
                                <td>Check the invoice type before deciding the code: 
                                    <br>- If the invoice has Food or Liquor items → Create line details.
                                    <br>- If the invoice has Non-Food items → Create line using XCG-101 (Purchase Summary).
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <h3 id="example-scenarios">💡 Example Scenarios - 1</h3>
                <div class="table-container">
                    <table>
                        <thead>
                            <tr>
                ...
                <h3 id="item-types">💡 Example Scenarios - 2</h3>
                <div class="table-container">
                    <table>
                        <thead>
                            <tr>
            ...
            <section id="invoice-number" class="section">
                ...
                <div class="rules-grid">
                    <div class="rule-card">
                        ...
                        <p>Example: "INV 123 456" → "INV123456"</p>
                    </div>
                    <div class="rule-card">
            ...
            <section id="liquor-split" class="section">
                <div class="section-header">
                    ...
                    <h2 class="section-title">Liquor Invoice – Split</h2>
                </div>
                ...
                <h3 id="split-rules">📘 SPLIT Rules</h3>
                <div class="rules-grid">
                    <div class="rule-card">
                        <h4>Rule 1</h4>
                        <p>If Bottle Quantity (BT Qty) is mentioned in the invoice → it is a SPLIT case.</p>
                        <p>Example: BT Qty: 6 bottles</p>
                    </div>
                    <div class="rule-card">
                        <h4>Rule 2</h4>
                        <p>If Pack > 1 and Bottle Quantity is shown → mark as SPLIT.</p>
                        <p>Example: Pack: 12, BT Qty: 6</p>
                    </div>
                    <div class="rule-card">
                        <h4>Rule 3</h4>
                        <p>If Pack = 1 and BT Qty = 1 → NOT SPLIT.</p>
                ...
                <h3 id="split-examples">💡 Examples</h3>
                <div class="table-container">
                    <table>
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>12</td>
                                <td>12</td>
                                <td>Full case equivalent – not split</td>
                                <td><span class="status status-no">No</span></td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <h3 id="bottle-calculation">🟦 Simple Rule (Funda)</h3>
                <div class="rules-grid">
                    <div class="rule-card">
                        <h4>Rule 1</h4>
                        <p>Whenever Bottle Quantity (BT Qty) is mentioned in the invoice and Pack is more than 1, ➡️ It will be considered as SPLIT.</p>
                        <p>Example: Pack: 12, BT Qty: 6 → SPLIT</p>
                    </div>
                    <div class="rule-card">
                        <h4>Rule 2</h4>
                        <p>Whenever Bottle Quantity (BT Qty) is mentioned in the invoice and Pack = 1, ➡️ It will NOT be considered as SPLIT.</p>
                        <p>Example: Pack: 1, BT Qty: 1 → NOT SPLIT</p>
                    </div>
                    <div class="rule-card">
                        <h4>Rule 3</h4>
                        <p>If only case quantity is mentioned without bottle quantity, ➡️ It is NOT SPLIT.</p>
                        <p>Example: 1 CS → NOT SPLIT</p>
                    </div>
                </div>
            ...
            <section id="standard-catch" class="section">
                <div class="section-header">
                    ...
                    <h2 class="section-title">Standard / Food Invoice – CATCH</h2>
                </div>
                ...
                <h3 id="catch-rules">📘 CATCH Rules</h3>
                <p>Mark a product as CATCH when weight is taken as the quantity. ✅</p>
                ...
                <h3 id="catch-examples">💡 Examples</h3>
                <div class="table-container">
                    <table>
                        <thead>
                            <tr>
                ...
                <div class="definition-box" style="border-left-color: var(--success);">
                    <h3>🟩 Note (Simple Rule / Funda)</h3>
                    <p>👉 If UOM (Unit of Measurement) is automatically shown as LB in the system, and the invoice also mentions LB, then it must be marked as CATCH. ✅</p>
                    <p>👉 If product is typically sold by weight (meat, produce, seafood) and has decimal quantity, mark as CATCH.</p>
                </div>
            ...
            <section id="freight-charge" class="section">
                ...
                <h3 id="practical-box">⚙️ How to Handle Charges in Invoice</h3>
                <div class="rules-grid">
                    <div class="rule-card">
                        <h4>🟩 Rule 1 – When Item Code is Available</h4>
                        <p>If the invoice contains a Charge and the Item Code for that charge is available in the invoice, ➡️ Take it in the Line Item section.</p>
                        <p>Create separate line with the charge item code</p>
                    </div>
                    <div class="rule-card">
                        <h4>🟨 Rule 2 – When Item Code is NOT Available</h4>
                        <p>If the invoice contains a Charge but the Item Code is not provided, ➡️ Enter it in the Practical Box (Remarks / Additional Field).</p>
                        <p>Note: Include amount and description</p>
                    </div>
                    <div class="rule-card">
                        <h4>🟦 Rule 3 – Multiple Charges</h4>
                        <p>If multiple charges with no item codes, ➡️ Combine in Practical Box with clear descriptions.</p>
                ...
                <div class="step-indicator">
                    ...
                    <div class="step-content">
                        ...
                        <p>Item code available → Line Item<br>No item code → Practical Box</p>
                    </div>
                </div>
                ...
                <div class="definition-box" style="border-left-color: var(--success);">
                    <h3>🟦 Simple Rule (Funda)</h3>
                    <p>🔹 If charge has Item Code → Line Item<br>🔹 If charge has no Item Code → Practical Box<br>🔹 Always include description and amount for Practical Box entries</p>
                </div>
            ...
            <section id="deposit" class="section">
                <div class="section-header">
                    ...
                    <h2 class="section-title">Liquor Invoice – Deposit</h2>
                </div>
                
                <div class="definition-box" id="deposit-categories">
                    <h3>⚙️ DEPOSIT Categories</h3>
                ...
                <h3 id="keg-deposit">LIQUOR INVOICE – KEG DEPOSIT</h3>
                <div class="definition-box">
                    <h3>📘 Definition</h3>
                ...
                <h3 id="deposit-examples">💡 Example Scenarios - KEG DEPOSIT</h3>
                <div class="table-container">
                    <table>
                        <thead>
                            <tr>
                ...
                <h3 id="deposit-on-item">LIQUOR INVOICE – DEPOSIT ON ABOVE ITEM</h3>
                <div class="definition-box">
                    <h3>📘 Definition</h3>
                ...
                <h3>💡 Example Scenarios - DEPOSIT ON ABOVE ITEM</h3>
                <div class="table-container">
                    <table>
                        <thead>
                            <tr>
                ...
                <h3 id="keg-return">LIQUOR INVOICE – KEG RETURN</h3>
                <div class="definition-box">
                    <h3>📘 Definition</h3>
                ...
                <h3>💡 Example Scenarios - KEG RETURN</h3>
                <div class="table-container">
                    <table>
                        <thead>
                            <tr>
            ...
            <section id="discount" class="section">
                ...
                <h3 id="discount-conditions">⚙️ When to Apply</h3>
                <div class="table-container">
                    <table>
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>"NO CHARGE – Sample Wine Bottle"</td>
                            </tr>
                            <tr>
                                <td>🟩 Free Quantity</td>
                ...
                <h3 id="discount-steps">✅ How to Create the 100% Discount Line</h3>
                <div class="table-container">
                    <table>
                        <thead>
                            <tr>
                ...
                <h3 id="discount-examples">💡 Example Scenarios</h3>
                <div class="table-container">
                    <table>
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>"Cider – Unit Price = Discount"</td>
                                <td>Unit Price & Discount</td>
                                <td><span class="status status-yes">Create 100% Discount lines</span></td>
                                <td>2 lines: +0.01 and -0.01</td>
                            </tr>
            ...
            <section id="credit-memo" class="section">
                ...
                <h3 id="credit-keywords">⚙️ When to Mark as CREDIT MEMO</h3>
                ...
                <h3 id="credit-examples">💡 Example Scenarios</h3>
                <div class="table-container">
                    <table>
                        <thead>
                            <tr>
            ...
            <section id="quiz-section" class="quiz-section">
                ...
                <div class="quiz-levels">
                    <div class="level-card" data-level="1">
                        ...
                        <div class="level-difficulty difficulty-easy">Easy • 10 Questions</div>
                    </div>
                    ...
                    <div class="level-card" data-level="2">
                        ...
                        <div class="level-difficulty difficulty-medium">Medium • 15 Questions</div>
                    </div>
                    ...
                    <div class="level-card" data-level="3">
                        ...
                        <div class="level-difficulty difficulty-hard">Hard • 20 Questions</div>
                    </div>
                    ...
                    <div class="level-card" data-level="4">
                        ...
                        <div class="level-difficulty difficulty-expert">Expert • 30 Questions</div>
                    </div>
                </div>
        ...
        const ttsManager = {
            ...
            translations: {
                en: {
                    ...
                    'Liquor Invoice – Split': 'Liquor Invoice – Split',
                    'Standard / Food Invoice – CATCH': 'Standard / Food Invoice – CATCH',
                    'Freight Charge & Other Charge': 'Freight Charge & Other Charge',
                    'Liquor Invoice – Deposit': 'Liquor Invoice – Deposit',
                    ...
                    'LIQUOR INVOICE – KEG DEPOSIT': 'LIQUOR INVOICE – KEG DEPOSIT',
                    'LIQUOR INVOICE – DEPOSIT ON ABOVE ITEM': 'LIQUOR INVOICE – DEPOSIT ON ABOVE ITEM',
                    'LIQUOR INVOICE – KEG RETURN': 'LIQUOR INVOICE – KEG RETURN',
                ...
                hi: {
                    // Section titles
                    'Invoice Processing Guidelines': 'चालान प्रसंस्करण दिशानिर्देश',
                    'How to Process the Invoice': 'चालान कैसे संसाधित करें',
                    'Purchase Order (PO Number)': 'क्रय आदेश (PO नंबर)',
                    'Due Date': 'नियत तारीख',
                    'Invoice Number & Invoice Date': 'चालान नंबर और चालान तारीख',
                    'Liquor Invoice – Split': 'शराब चालान – विभाजित',
                    'Standard / Food Invoice – CATCH': 'मानक / खाद्य चालान – CATCH',
                    'Freight Charge & Other Charge': 'माल ढुलाई शुल्क और अन्य शुल्क',
                    'Liquor Invoice – Deposit': 'शराब चालान – जमा',
                    '100% Discount': '100% छूट',
                    'Credit Memo': 'क्रेडिट ज्ञापन',
                    'Invoice Processing Training Quiz': 'चालान प्रसंस्करण प्रशिक्षण प्रश्नोत्तरी',
                    'Document Upload Center': 'दस्तावेज़ अपलोड केंद्र',
                    
                    // Common terms
                    'Definition': 'परिभाषा',
                    'Examples': 'उदाहरण',
                    'Rules': 'नियम',
                    'Processing Steps': 'प्रसंस्करण चरण',
                    'Important Note': 'महत्वपूर्ण नोट',
                    'When to Apply': 'कब लागू करें',
                    'How to Create': 'कैसे बनाएं',
                    'Common Questions': 'सामान्य प्रश्न',
                    'Summary': 'सारांश',
                    'General Rules': 'सामान्य नियम',
                    'Example Scenarios': 'उदाहरण परिदृश्य',
                    'Item Types': 'आइटम प्रकार',
                    'Common Terms Used': 'प्रयुक्त सामान्य शब्द',
                    'PO Number Format': 'PO नंबर प्रारूप',
                    'Examples from Different Vendors': 'विभिन्न विक्रेताओं के उदाहरण',
                    'Due Date Calculation Methods': 'नियत तारीख गणना विधियाँ',
                    'Special Cases and Exceptions': 'विशेष मामले और अपवाद',
                    'Invoice Number Format Rules': 'चालान नंबर प्रारूप नियम',
                    'Date Format Rules': 'तारीख प्रारूप नियम',
                    'SPLIT Rules': 'विभाजन नियम',
                    'Simple Rule (Funda)': 'सरल नियम (फंडा)',
                    'Common Scenarios & Solutions': 'सामान्य परिदृश्य और समाधान',
                    'CATCH Rules': 'कैच नियम',
                    'How to Validate CATCH Items': 'कैच आइटम कैसे मान्य करें',
                    'UOM Conversion Reference': 'यूओएम रूपांतरण संदर्भ',
                    'Examples of Freight Charges': 'माल ढुलाई शुल्क के उदाहरण',
                    'Examples of Other Charges': 'अन्य शुल्कों के उदाहरण',
                    'How to Handle Charges in Invoice': 'चालान में शुल्क कैसे संभालें',
                    'Processing Steps for Charges': 'शुल्कों के लिए प्रसंस्करण चरण',
                    'Common Mistakes to Avoid': 'बचने के लिए सामान्य गलतियाँ',
                    'DEPOSIT Categories': 'जमा श्रेणियाँ',
                    'LIQUOR INVOICE – KEG DEPOSIT': 'शराब चालान - केग जमा',
                    'LIQUOR INVOICE – DEPOSIT ON ABOVE ITEM': 'शराब चालान - ऊपर के आइटम पर जमा',
                    'LIQUOR INVOICE – KEG RETURN': 'शराब चालान - केग वापसी',
                    'Summary Table - Deposit Types': 'सारांश तालिका - जमा प्रकार',
                    'When to Apply 100% Discount': '100% छूट कब लागू करें',
                    'How to Create the 100% Discount Line': '100% छूट लाइन कैसे बनाएं',
                    'Detailed Example: 100% Discount with SPLIT': 'विस्तृत उदाहरण: विभाजन के साथ 100% छूट',
                    'Common Questions & Answers': 'सामान्य प्रश्न और उत्तर',
                    'When to Mark as CREDIT MEMO': 'क्रेडिट मेमो के रूप में कब चिह्नित करें',
                    'How to Process Credit Memos': 'क्रेडिट मेमो कैसे संसाधित करें',
                    'Reverse Processing Rules': 'उल्टा प्रसंस्करण नियम',
                    'Drag & Drop Files Here': 'फ़ाइलें यहाँ खींचें और छोड़ें',
                    'or click to browse': 'या ब्राउज़ करने के लिए क्लिक करें'
                },
                gu: {
                    // Section titles
                    'Invoice Processing Guidelines': 'ઇનવોઇસ પ્રોસેસિંગ દિશાનિર્દેશો',
                    'How to Process the Invoice': 'ઇનવોઇસ કેવી રીતે પ્રોસેસ કરવો',
                    'Purchase Order (PO Number)': 'પરચેઝ ઓર્ડર (PO નંબર)',
                    'Due Date': 'નિયત તારીખ',
                    'Invoice Number & Invoice Date': 'ઇનવોઇસ નંબર અને ઇનવોઇસ તારીખ',
                    'Liquor Invoice – Split': 'લિકર ઇનવોઇસ – વિભાજિત',
                    'Standard / Food Invoice – CATCH': 'સ્ટાન્ડર્ડ / ફૂડ ઇનવોઇસ – CATCH',
                    'Freight Charge & Other Charge': 'ફ્રેટ ચાર્જ અને અન્ય ચાર્જ',
                    'Liquor Invoice – Deposit': 'લિકર ઇનવોઇસ – જમા',
                    '100% Discount': '100% ડિસ્કાઉન્ટ',
                    'Credit Memo': 'ક્રેડિટ મેમો',
                    'Invoice Processing Training Quiz': 'ઇનવોઇસ પ્રોસેસિંગ તાલીમ ક્વિઝ',
                    'Document Upload Center': 'દસ્તાવેજ અપલોડ કેન્દ્ર',
                    
                    // Common terms
                    'Definition': 'વ્યાખ્યા',
                    'Examples': 'ઉદાહરણો',
                    'Rules': 'નિયમો',
                    'Processing Steps': 'પ્રોસેસિંગ સ્ટેપ્સ',
                    'Important Note': 'મહત્વપૂર્ણ નોંધ',
                    'When to Apply': 'ક્યારે લાગુ કરવું',
                    'How to Create': 'કેવી રીતે બનાવવું',
                    'Common Questions': 'સામાન્ય પ્રશ્નો',
                    'Summary': 'સારાંશ',
                    'General Rules': 'સામાન્ય નિયમો',
                    'Example Scenarios': 'ઉદાહરણ પરિસ્થિતિઓ',
                    'Item Types': 'આઇટમ પ્રકારો',
                    'Common Terms Used': 'વપરાયેલા સામાન્ય શબ્દો',
                    'PO Number Format': 'PO નંબર ફોર્મેટ',
                    'Examples from Different Vendors': 'વિવિધ વેન્ડર્સના ઉદાહરણો',
                    'Due Date Calculation Methods': 'નિયત તારીખ ગણતરી પદ્ધતિઓ',
                    'Special Cases and Exceptions': 'ખાસ કેસ અને અપવાદો',
                    'Invoice Number Format Rules': 'ઇનવોઇસ નંબર ફોર્મેટ નિયમો',
                    'Date Format Rules': 'તારીખ ફોર્મેટ નિયમો',
                    'SPLIT Rules': 'વિભાજન નિયમો',
                    'Simple Rule (Funda)': 'સરળ નિયમ (ફંડા)',
                    'Common Scenarios & Solutions': 'સામાન્ય પરિસ્થિતિઓ અને ઉકેલો',
                    'CATCH Rules': 'કેચ નિયમો',
                    'How to Validate CATCH Items': 'કેચ આઇટમ્સ કેવી રીતે માન્ય કરવી',
                    'UOM Conversion Reference': 'UOM કન્વર્ઝન સંદર્ભ',
                    'Examples of Freight Charges': 'ફ્રેટ ચાર્જના ઉદાહરણો',
                    'Examples of Other Charges': 'અન્ય ચાર્જના ઉદાહરણો',
                    'How to Handle Charges in Invoice': 'ઇનવોઇસમાં ચાર્જ કેવી રીતે સંભાળવા',
                    'Processing Steps for Charges': 'ચાર્જ માટે પ્રોસેસિંગ સ્ટેપ્સ',
                    'Common Mistakes to Avoid': 'ટાળવા માટે સામાન્ય ભૂલો',
                    'DEPOSIT Categories': 'જમા શ્રેણીઓ',
                    'LIQUOR INVOICE – KEG DEPOSIT': 'લિકર ઇનવોઇસ - કેગ ડિપોઝિટ',
                    'LIQUOR INVOICE – DEPOSIT ON ABOVE ITEM': 'લિકર ઇનવોઇસ - ઉપરના આઇટમ પર જમા',
                    'LIQUOR INVOICE – KEG RETURN': 'લિકર ઇનવોઇસ - કેગ રીટર્ન',
                    'Summary Table - Deposit Types': 'સારાંશ કોષ્ટક - જમા પ્રકારો',
                    'When to Apply 100% Discount': '100% ડિસ્કાઉન્ટ ક્યારે લાગુ કરવું',
                    'How to Create the 100% Discount Line': '100% ડિસ્કાઉન્ટ લાઇન કેવી રીતે બનાવવી',
                    'Detailed Example: 100% Discount with SPLIT': 'વિસ્તૃત ઉદાહરણ: SPLIT સાથે 100% ડિસ્કાઉન્ટ',
                    'Common Questions & Answers': 'સામાન્ય પ્રશ્નો અને જવાબો',
                    'When to Mark as CREDIT MEMO': 'ક્રેડિટ મેમો તરીકે ક્યારે ચિહ્નિત કરવું',
                    'How to Process Credit Memos': 'ક્રેડિટ મેમો કેવી રીતે પ્રોસેસ કરવું',
                    'Reverse Processing Rules': 'વિપરીત પ્રોસેસિંગ નિયમો',
                    'Drag & Drop Files Here': 'ફાઇલો અહીં ખેંચો અને છોડો',
                    'or click to browse': 'અથવા બ્રાઉઝ કરવા માટે ક્લિક કરો'
                }
            },
            ...
            3: [
                ...
                },
                {
                    ...
                    options: [
                        ...
                        "Bottle quantity ÷ Pack size",
                        "External Amount ÷ Unit Price"
                    ],
                    correctAnswer: 0,
                ...
                },
                {
                    ...
                    correctAnswer: 0,
                    explanation: "If charge has no Item Code → Practical Box"
                },
                {
                    id: 9,
                ...
                },
                {
                    ...
                    correctAnswer: 0,
                    explanation: "Simple Rule: If UOM is LB in system and invoice mentions LB → mark as CATCH"
                },
                {
                    id: 18,
                    question: "How to handle Other Charges like 'City Surcharge'?",
                    options: [
                        "Check if Item Code exists: if yes → Line Item, if no → Practical Box",
                        "Always put in Practical Box",
                        "Always create line item",
                        "Ignore as it's tax-related"
                    ],
                    correctAnswer: 0,
                    explanation: "Other Charges: Item Code available → Line Item, no Item Code → Practical Box"
                },
                {
                    id: 19,
...
• Ctrl+Alt+Space: Play/Pause TTS
• Ctrl+Alt+S: Stop TTS
• Ctrl+Alt+E/H/G: Switch to English/Hindi/Gujarati`;
        ...
        function submitQuiz() {
            ...
            let message = "";
            if (percentage >= 90) {
                message = "Excellent! You're an invoice processing expert! 🏆";
